...
public class RuleWeightLogicFilter implements ILogicFilter<RuleActionEntity.RaffleBeforeEntity> {
    ...
    public RuleActionEntity<RuleActionEntity.RaffleBeforeEntity> filter(RuleMatterEntity ruleMatterEntity) {
        ...
        Integer userId = Integer.parseInt(ruleMatterEntity.getUserId());
        Long strategyId = ruleMatterEntity.getStrategyId();

        //ruleValue  4000:102,103,104,105 5000:102,103,104,105,106,107 6000:102,103,104,105,106,107,108,109
        String ruleValue = repository.queryStrategyRuleValue(strategyId,ruleMatterEntity.getRuleModel(),ruleMatterEntity.getAwardId());
