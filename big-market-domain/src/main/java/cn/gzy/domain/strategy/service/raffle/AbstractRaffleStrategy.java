...
public abstract class AbstractRaffleStrategy implements IRaffleStrategy {
    ...
    public RaffleAwardEntity performRaffle(RaffleFactorEntity raffleFactorEntity) {
        ...
        //3.抽奖前策略过滤
        RuleActionEntity<RuleActionEntity.RaffleBeforeEntity> ruleActionEntity = doCheckRaffleBeforeLogic(raffleFactorEntity,strategy.ruleModels());
        ...
        StrategyAwardRuleModelVO ruleModels = repository.queryStrategyAwardRuleModels(strategyId,awardId);
        String[] ruleModelArr = ruleModels.raffleCenterRuleModelList();
        raffleFactorEntity.setAwardId(awardId);
        RuleActionEntity<RuleActionEntity.RaffleCenterEntity> ruleActionCenterEntity = doCheckRaffleCenterLogic(raffleFactorEntity,ruleModelArr);
