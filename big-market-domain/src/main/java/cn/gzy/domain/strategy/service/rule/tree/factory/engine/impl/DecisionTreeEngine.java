package cn.gzy.domain.strategy.service.rule.tree.factory.engine.impl;

import cn.gzy.domain.strategy.model.valobj.RuleLogicCheckTypeVO;
import cn.gzy.domain.strategy.model.valobj.RuleTreeNodeLineVO;
...
import cn.gzy.domain.strategy.service.rule.tree.factory.engine.IDecisionTreeEngine;
...
public class DecisionTreeEngine implements IDecisionTreeEngine {
    ...
    public DefaultTreeFactory.StrategyAwardVO process(String userId, Long strategyId, Integer awardId) {
        ...
        while( ruleTreeNode != null){
            ...
            // 节点执行业务流程
            DefaultTreeFactory.TreeActionEntity logicEntity = logicTreeNode.logic(strategyId,userId,awardId,ruleValue);
