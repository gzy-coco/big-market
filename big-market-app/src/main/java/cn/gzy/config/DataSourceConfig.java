...
public class DataSourceConfig {
    ...
    @Configuration
    @MapperScan(basePackages = "cn.gzy.infrastructure.elasticsearch", sqlSessionFactoryRef = "elasticsearchSqlSessionFactory")
    ...
    @Configuration
    @MapperScan(basePackages = "cn.gzy.infrastructure.dao", sqlSessionFactoryRef = "mysqlSqlSessionFactory")
